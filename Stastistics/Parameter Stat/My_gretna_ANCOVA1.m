function [ANCOVA_F, ANCOVA_P] = My_gretna_ANCOVA1(DependentFiles, Covariates)
% TTest1_T = gretna_TTest1(DependentDirs, OutputName, OtherCovariates, Base)
% Perform One-Way ANCOVA/ANOVA.
% Input:
...
[~, ~, ANCOVA_F, ~] = My_gretna_GroupAnalysis(DependentMatrix, Regressors, Contrast, 'F');
